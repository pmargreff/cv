...
\begin{itemize}
\item{\cventry{Dezembro 2015 -- Atualmente}{Back-End}{Desenvolvedor}{Zero || Um}{}{\vspace{3pt}Desenvolvimento e manutenção de plataformas web, com foco em soluções tecnológicas voltadas para a área de educação. Suporte e migração a diversos tipos de sistemas, com foco em frameworks e tecnologias PHP e Java.}}

\vspace{6pt}

\item{\cventry{Fevereiro 2013 -- Fevereiro 2014}{Departamento Comercial}{Auxiliar Administrativo}{Unimed - Vales do Taquari e Rio Pardo}{}
...
\item{\cventry{Janeiro 2012 -- Fevereiro 2013}{Departamento Comercial}{Jovem Aprendiz}{Unimed - Vales do Taquari e Rio Pardo}{}{\vspace{3pt}Auxilio nas tarefas do departamento comercial, como reposição de material e ajuda na conferência das corespondências para clientes. Além de suporte em tarefas do departamento financeiro.}}
